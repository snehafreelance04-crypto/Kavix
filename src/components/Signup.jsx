...
, 2000);
  ...
  return (
    <div className="relative min-h-screen flex md:flex-row flex-col bg-white">
      ...
      <div
        className="hidden md:flex w-1/2 h-screen bg-[url('https://img.freepik.com/free-photo/abstract-background-with-dark-blue-grunge-texture_1048-20452.jpg?w=740')] bg-cover bg-center items-center justify-center"
      >
      ...
      {/* SIGNUP CARD — Responsive like Login.jsx */}
      <div
        className="
